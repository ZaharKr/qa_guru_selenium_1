...
class TextBoxPage:
    ...
    def is_email_error_present(self):
        ...
        field_class = email_field.get_attribute("class") or ""
        return "field-error" in field_class or "error" in field_class

    def is_email_valid(self):
        email_field = self.driver.find_element(*self.EMAIL)
        return email_field.get_property("validity")["valid"]

    def get_name_inner_html(self):
        return self.driver.find_element(*self.OUTPUT_NAME).get_attribute("innerHTML")
